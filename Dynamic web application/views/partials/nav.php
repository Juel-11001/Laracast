				...
				<div class="flex items-center">
					...
					<div class="hidden md:block">
						<div class="ml-10 flex items-baseline space-x-4">
							...
							<a href="/" class="<?= urlIs('/') ? 'bg-gray-900': 'text-gray-300'?> rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-gray-700 hover:text-white" aria-current="page">Home</a>
							<a href="/about" class=" <?= urlIs('/about') ? 'bg-gray-900': 'text-gray-300'?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">about</a>
							<a href="/contact" class=" <?= urlIs('/contact') ? 'bg-gray-900': 'text-gray-300'?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">contact</a>
                            <a href="/notes" class=" <?= urlIs('/notes') ? 'bg-gray-900': 'text-gray-300'?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Notes</a>
						</div>
					</div>
				</div>
				<div class="hidden md:block">
