  ...
  <main>
      <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
          <div class="sm:mx-auto sm:w-full sm:max-w-sm">
              ...
              <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Register For new User</h2>
          </div>
              ...
              <form class="space-y-6" action="/register" method="POST">
                  <div>
					  ...
					  <?php if (isset($errors['email'])) : ?>
                          <p class="mt-3 text-red-500 text-xs"><?= $errors['email'] ?></p>
					  <?php endif; ?>
                  </div>
                  ...
                  <div>
					  ...
					  <?php if (isset($errors['password'])) : ?>
                          <p class="mt-3 text-red-500 text-xs"><?= $errors['password'] ?></p>
					  <?php endif; ?>
                  </div>
